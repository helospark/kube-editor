...
public class YEditLog {
    ...
    public static String TRACE_LEVEL_OPTION = KubeEditorActivator.PLUGIN_ID + "/debug/trace_level";
    ...
    public static void logException(Throwable exception, String message) {
        ...
        IStatus status = new Status(IStatus.ERROR, KubeEditorActivator.PLUGIN_ID, IStatus.OK, message, exception);
        KubeEditorActivator.getDefault().getLog().log(status);

    }

    public static void logError(String message) {

        IStatus status = new Status(IStatus.ERROR, KubeEditorActivator.PLUGIN_ID, message);
        KubeEditorActivator.getDefault().getLog().log(status);
