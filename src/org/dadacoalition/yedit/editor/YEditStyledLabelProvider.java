...
public class YEditStyledLabelProvider extends StyledCellLabelProvider {
    ...
    public void update(ViewerCell cell) {
        ...
        if (e instanceof YAMLOutlineElement) {
            ...
            boolean showTags = KubeEditorActivator.getDefault().getPreferenceStore().getBoolean(PreferenceConstants.OUTLINE_SHOW_TAGS);
            if (showTags) {
    ...
    private String elementLabel(YAMLOutlineElement element) {
        ...
        if (0 == element.children.size()) {
            ...
            int maxLength = KubeEditorActivator.getDefault().getPreferenceStore().getInt(PreferenceConstants.OUTLINE_SCALAR_MAX_LENGTH);
    ...
    private static ImageDescriptor create(String name) {
        ...
        return createImageDescriptor(KubeEditorActivator.getDefault().getBundle(), path);
    }
