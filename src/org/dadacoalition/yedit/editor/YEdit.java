...
public class YEdit extends TextEditor {
    ...
    public static final String SOURCE_VIEWER_CONFIGURATION_CONTRIB_ID = KubeEditorActivator.PLUGIN_ID + ".sourceViewerConfigurationContribution";
    ...
    public void dispose() {
        ...
        try {
            ...
            KubeEditorActivator.getDefault().getPreferenceStore().removePropertyChangeListener(propertyChangeListener);
    ...
    public void createPartControl(Composite parent) {
        ...
        KubeEditorActivator.getDefault().getPreferenceStore().addPropertyChangeListener(propertyChangeListener);
    ...
    void locateTaskTags() {
        ...
        boolean caseSensitiveTags = Boolean.valueOf(KubeEditorActivator.getDefault().getPreferenceStore().getString(PreferenceConstants.TODO_TASK_CASE_SENSITIVE));
    ...
    private List<TaskTagPreference> getTaskTagPreferences() {
        return TaskTagPreference.getTaskTagPreferences(KubeEditorActivator.getDefault().getPreferenceStore());
    }
    ...
    public boolean formatDocument() {
        ...
        String content = document.get();
        Yaml yamlParser = new Yaml();
        YamlFormatter formatter = FormatterUtils.preferencesToFormatter(KubeEditorActivator.getDefault().getPreferenceStore());
